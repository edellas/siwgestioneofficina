package it.uniroma3.siw.gestioneofficina.authentication;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index",
                        "/login", "/register","/tipologiaintervento",
                ...
                .antMatchers(HttpMethod.GET, "/admin/**","/meccanici","/utenti").hasAnyAuthority(ADMIN_ROLE)
